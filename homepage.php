    ...
    <script>
        ...
        const tipLibrary = {
            home: [
                ...
                "Install updates as soon as security patches are released.",
                "Never share MFA codes with anyone.",
                "Be cautious with urgent requests involving money or credentials.",
                ...
                "Public Wi-Fi should not be trusted for sensitive logins.",
                "Use encrypted connections whenever possible.",
                "Check URLs carefully before entering passwords.",
                "Attackers often impersonate trusted brands and coworkers.",
                "Security awareness is just as important as technical defenses.",
                "Old unused accounts should be disabled or deleted.",
                "Do not ignore unusual account activity notifications.",
                "Data breaches can expose reused passwords instantly.",
                ...
                "Social engineering attacks target human trust.",
                "Keep backup copies of important files offline.",
                "Be cautious with QR codes from unknown sources.",
                "Browser updates often contain critical security fixes.",
                "Use official app stores whenever possible.",
                "Never assume a familiar logo means a message is legitimate."
            ],
            ...
            password: [
                ...
                "Avoid predictable substitutions like Password123.",
                "Every important account should have a unique password.",
                "Generated passwords are often safer than human-created ones.",
                "Avoid keyboard patterns like qwerty or 123456.",
                "Never share passwords through email or chat.",
                "Use random password generation for sensitive accounts.",
                "Short passwords can be brute-forced quickly.",
                "Adding length improves password strength significantly.",
                "Avoid using company names or usernames in passwords.",
                "Change passwords immediately if compromise is suspected.",
                "Store recovery codes securely offline.",
                "Security questions should not use public information.",
                "Do not recycle old passwords after resets.",
                "Password managers help prevent reuse attacks.",
                "Strong passwords reduce credential stuffing risks.",
                "Avoid using single dictionary words alone.",
                "A long memorable phrase is often stronger than a short complex password.",
                "Use separate passwords for banking and email accounts.",
                "Your email password should be one of your strongest passwords.",
                "Weak passwords can compromise multiple linked accounts.",
                "Avoid storing passwords in browser notes or text files.",
                "Randomly generated passwords are harder to predict.",
                "Password reuse is one of the biggest account security risks.",
                "Compromised passwords should never be reused again.",
                "Enable MFA alongside strong passwords for better protection.",
                "Even strong passwords should be unique per service."
            ],
            ...
            phishing: [
                ...
                "Emails demanding immediate action are often malicious.",
                "Check for unusual grammar and spelling mistakes.",
                "Fake login pages often mimic real services closely.",
                "Never trust unexpected password reset emails immediately.",
                "Shortened URLs can hide dangerous destinations.",
                "Verify suspicious requests through official contact channels.",
                "Phishing attacks often use fear or urgency.",
                "Be cautious with invoices or delivery notifications you did not expect.",
                "Do not download attachments from unknown senders.",
                "A familiar logo does not guarantee legitimacy.",
                "Attackers may spoof coworker or executive identities.",
                "Check domains carefully before entering credentials.",
                "Unexpected MFA prompts can indicate account compromise attempts.",
                "Smishing attacks use text messages instead of email.",
                "Voice phishing scams attempt to manipulate users over the phone.",
                "Malicious links may lead to cloned login portals.",
                "Suspicious QR codes can redirect to phishing websites.",
                "Always verify payment requests independently.",
                "Phishing attacks target emotions and trust.",
                "Browser warnings about unsafe websites should not be ignored.",
                "Fake support emails often request credentials or payments.",
                "Never send passwords through email.",
                "Some phishing emails contain no malicious attachments at all.",
                "Compromised accounts are often used to spread phishing messages.",
                "Legitimate companies rarely ask for passwords directly.",
                "Unexpected shared document links should be treated carefully."
            ],
            ...
            breach: [
                ...
                "Monitor accounts for unusual activity after a breach.",
                "Compromised credentials may circulate for years online.",
                "Reset passwords for linked accounts too.",
                "Watch for unauthorized password reset attempts.",
                "Enable account alerts where available.",
                "Breached passwords should never be reused again.",
                "Attackers often test leaked credentials on multiple services.",
                "Check whether MFA settings were altered after compromise.",
                "Verify backup recovery methods remain secure.",
                "Compromised email accounts can endanger other accounts.",
                "Financial accounts should be reviewed after identity exposure.",
                "Watch for phishing attempts after public data breaches.",
                "Security breaches can expose personal information beyond passwords.",
                "Update passwords starting with your most important accounts.",
                "Review connected apps and third-party integrations.",
                "Disable unused sessions after suspicious activity.",
                "Check for unauthorized forwarding rules in email accounts.",
                "Data breaches increase credential stuffing risks.",
                "Avoid panic and work methodically after a compromise.",
                "Document suspicious activity for future reference.",
                "Consider freezing credit after major identity-related breaches.",
                "Use unique passwords to limit breach impact.",
                "Breach notifications should always be taken seriously.",
                "Attackers may sell stolen credentials on underground forums.",
                "Reset API keys or tokens if they may be exposed.",
                "Check device security after an account compromise.",
                "Review cloud storage permissions after suspicious activity."
            ]
        };
